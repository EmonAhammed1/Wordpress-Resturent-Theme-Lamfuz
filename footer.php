        ...
        <div class="footer-container">
            ...
            <div class="footer-columns">
                ...
                <div class="footer-col footer-col-contact">
                    ...
                    <a href="tel:+4570605657" class="footer-contact-link"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0;"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg><span>70 60 56 57</span></a>
                    <a href="mailto:INFO@LAMFUZ.COM" class="footer-contact-link"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg><span>INFO@LAMFUZ.COM</span></a>
                    <div class="show-da">
                        <p class="footer-contact-address"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0; margin-top: 3px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg><span>TURESENSGADE 6, 1368,<br>KØBENHAVN K,<br>DENMARK</span></p>
                    </div>
                    <div class="show-en notranslate">
                        <p class="footer-contact-address"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0; margin-top: 3px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg><span>TURESENSGADE 6, 1368,<br>COPENHAGEN K,<br>DENMARK</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-links">
                    ...
                    <a href="https://www.findsmiley.dk/Sider/Search.aspx?k=lamfuz" target="_blank" rel="noopener noreferrer">😊 Find Smiley</a>
                </div>
