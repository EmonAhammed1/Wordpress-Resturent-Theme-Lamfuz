...
<main id="primary" class="site-main">
        ...
        <section class="contact-info-section" style="background-color: #fff8e6; padding: 6rem 2rem;">
            ...
            <div class="contact-details-row" style="max-width: 1000px; margin: 0 auto; display: flex; gap: 4rem; align-items: stretch; justify-content: center; flex-wrap: wrap;">
                ...
                <!-- Text Column -->
                <div class="contact-text-column" style="flex: 1; max-width: 420px; min-width: 300px; color: #b2512b; display: flex; flex-direction: column; justify-content: center; gap: 1.5rem;">
                    <div>
                        <div class="show-da">
