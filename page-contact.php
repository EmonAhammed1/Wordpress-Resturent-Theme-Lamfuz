...
<main id="primary" class="site-main">
        ...
        <section class="contact-info-section" style="background-color: #fff8e6; padding: 6rem 2rem;">
            ...
            <!-- Full Width Heading -->
            <h2 class="contact-main-title">KONTAKT LAMFUZ –<br class="mobile-br">VI ER KLAR TIL AT<br>HJÆLPE DIG</h2>
            ...
            <div class="contact-container" style="max-width: 1200px; margin: 0 auto; display: flex; gap: 4rem; flex-wrap: wrap;">
                ...
                <div class="contact-text-area" style="flex: 1; min-width: 300px; color: #b2512b;">
                    ...
                    <p style="margin-bottom: 3rem; font-family: var(--font-body); line-height: 1.8; font-size: 17px;">Uanset om du skriver, ringer eller kigger forbi, står vi klar med åbne arme og duften af frisklavet nepalesisk mad.</p>
